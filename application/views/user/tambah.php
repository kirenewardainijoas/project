								...
								<form action="<?= base_url('user/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="id_user" placeholder="Masukkan ID User" autocomplete="off"  class="form-control" required value="USER - <?= mt_rand(10, 99) ?>" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="email"><strong>Email</strong></label>
											<input type="text" name="email" placeholder="Masukkan Email User" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<div class="form-row">
											<div class="form-group col-md-6">
