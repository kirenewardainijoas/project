				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('peratanyaan/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="id_pertanyaan"><strong>ID Pertanyaan</strong></label>
											<input type="text" name="id_pertanyaan" placeholder="Masukkan ID Pertanyaan" autocomplete="off"  class="form-control" required>
										</div>
										<div class="form-group col-md-6">
											<label for="soal"><strong>Soal</strong></label>
											<input type="text" name="soal" placeholder="Masukkan Soal" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<!-- <div class="form-row">
										<div class="form-group col-md-6">
